...
namespace UploadTest
{
    ...
    {
        static string ConnectString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OperaContext"].ToString();
        ...
        public void SetGV()
        {
            ...
            {
                string query = "select * from  FileTB order by id";
